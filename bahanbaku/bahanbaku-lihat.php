  ...
  <div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar">
      <div class="p-4 pt-5 text-center">
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li class="active"><a href="#bahanbaku-lihat.php" data-toggle="collapse" aria-expanded="false"><i class="fas fa-cubes"></i> Bahan Baku</a></li>
    ...
    <div id="content" class="main-content">
      <div class="page-header">
        ...
        <a href="bahanbaku-tambah.php" class="btn btn-warning shadow-sm font-weight-bold">
          <i class="fa fa-plus"></i> TAMBAHKAN
        </a>
        <small class="text-muted">Terakhir diperbarui: <?php echo date('d M Y, H:i A', strtotime('10:50 AM WIB')); ?> WIB</small>
      </div>
      ...
      <div class="table-container">
        <table id="example" class="table table-striped table-bordered">
          ...
          <tbody>
            <?php
            include '../koneksi.php';
            $query = mysqli_query($conn, "SELECT * FROM bahanbaku");
            while ($data = mysqli_fetch_array($query)) {
            ?>
              <tr>
                <td><?php echo $data['kode_bahanbaku']; ?></td>
                <td style="text-align: start;"><?php echo $data['nama_bahanbaku']; ?></td>
                <td>Rp <?php echo number_format($data['harga_satuan'], 0, ',', '.'); ?></td>
                <td>
                  <div class="action-buttons">
                    <a class="btn btn-success btn-sm" href="bahanbaku-ubah.php?kode_bahanbaku=<?php echo $data['kode_bahanbaku']; ?>">Ubah</a>
                    <a class="btn btn-danger btn-sm" href="bahanbaku-hapus.php?kode_bahanbaku=<?php echo $data['kode_bahanbaku']; ?>" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                    <a class="btn btn-info btn-sm" href="bahanbakudetail-lihat.php?kode_bahanbaku=<?php echo $data['kode_bahanbaku']; ?>">Detail</a>
                  </div>
                </td>
              </tr>
            <?php } ?>
