  ...
  <div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar">
      <div class="p-4 pt-5 text-center">
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li class="active"><a href="#barang" data-toggle="collapse" aria-expanded="false"><i class="fa fa-box"></i> Barang</a></li>
    ...
    <div id="content" class="main-content">
        <div class="page-header">
          ...
          <a href="barang-tambah.php" class="btn btn-warning shadow-sm font-weight-bold">
              ...
              <tr>
                ...
                <td>
                  <div class="action-buttons">
                    <a class="btn btn-success btn-sm" href="barang-ubah.php?kode_barang=<?php echo $data['kode_barang']; ?>" role="button">Ubah</a>
                    <a class="btn btn-danger btn-sm" href="barang-hapus.php?kode_barang=<?php echo $data['kode_barang']; ?>" onclick="return confirm('yakin hapus?')">Hapus</a>
                    <a class="btn btn-info btn-sm" href="barangdetail-lihat.php?kode_barang=<?php echo $data['kode_barang']; ?>" role="button">Detail</a>
                  </div>
                </td>
              </tr>
            <?php } ?>
