...
if (isset($_POST['proses'])){
    ...
    mysqli_query($conn, "INSERT INTO barang VALUES('$kode_barang','$nama_barang','$harga_satuan')");
    header("location:barangdetail-tambah.php?kode_barang=".$kode_barang);
    ...
    <nav id="sidebar">
      ...
      <div class="form-container">
        ...
        <div class="form-group">
                ...
                <input type="number" name="harga_satuan" id="harga_satuan" class="form-control" placeholder="Masukkan Harga Barang" required>
            </div>
