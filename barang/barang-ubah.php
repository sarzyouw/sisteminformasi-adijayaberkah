...
if (isset($_POST['proses'])) {
  ...
  mysqli_query($conn, "UPDATE barang SET nama_barang='$nama_barang',harga_satuan='$harga_satuan' WHERE kode_barang='$kode_barang'");
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <<div id="content" class="main-content">
      <div class="page-header">
        ...
        <a href="barang-lihat.php" class="btn btn-warning shadow-sm font-weight-bold">
      ...
      <div class="form-container">
        ...
        <div class="form-group">
                ...
                <input type="text" name="kode_barang" id="kode_barang" class="form-control" value="<?=$data['kode_barang'] ?>" readonly>
            </div>
        ...
        <div class="form-group">
                ...
                <input type="text" name="harga_satuan" id="harga_satuan" class="form-control" value="<?=$data['harga_satuan'] ?>" required>
            </div>

           <div class="action-buttons">
            <a href="barang-lihat.php" class="btn btn-danger">
