...
<head>
  ...
  <style>
    ...
    /* Tambahan untuk format mata uang */
    .currency {
      text-align: right;
      white-space: nowrap;
    }
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="main-content">
      <div class="page-header">
        <h1 class="page-title">Data Nota</h1>
        <a href="nota-tambah.php" class="btn btn-warning shadow-sm font-weight-bold">
    ...
    p.jumlah_rp, 
    p.sisa,
    SUM(dp.banyaknya) AS jumlah_barang
FROM penjualan p
...
ORDER BY p.tanggal DESC");
            ...
            ?>
              <tr>
                ...
                <td class="currency"><?php echo number_format($data['dp'], 0, ',', '.'); ?></td>
                <td class="currency"><?php echo number_format($data['jumlah_rp'], 0, ',', '.'); ?></td>
                <td class="currency"><?php echo number_format($data['sisa'], 0, ',', '.'); ?></td>
                <td>
                  <div class="action-buttons">
                    <a class="btn btn-success btn-sm" href="nota-ubah.php?id_penjualan=<?php echo $data['id_penjualan']; ?>">Ubah</a>
                    <a class="btn btn-danger btn-sm" href="nota-hapus.php?id_penjualan=<?php echo $data['id_penjualan']; ?>" onclick="return confirm('yakin hapus?')">Hapus</a>
                  </div>
                </td>
                <td>
                  <div class="action-buttons">
                    <a class="btn btn-info btn-sm" href="notadetail-lihat.php?id_penjualan=<?php echo $data['id_penjualan']; ?>">Detail</a>
                    <a class="btn btn-primary btn-sm" href="notacetak.php?id_penjualan=<?php echo $data['id_penjualan']; ?>">Cetak</a>
                  </div>
                </td>
              </tr>
            <?php } ?>
  ...
  <script>
    $(document).ready(function () {
      $('#example').DataTable({
        ...
        "responsive": true,
        "autoWidth": false,
        "order": [[3, "desc"]], // Default urutkan berdasarkan tanggal terbaru
