...
if (isset($_POST['proses'])){
    ...
    mysqli_query($conn, "INSERT INTO pegawai VALUES('$id_pegawai','$nama_pegawai','$jabatan')");
      ...
      <div class="form-container">
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="id_pegawai" class="form-control" placeholder="Masukkan ID Pegawai" required>
            </div>
