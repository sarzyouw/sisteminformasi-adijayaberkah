  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="main-content">
      <div class="page-header">
        ...
        <a href="pelanggan-tambah.php" class="btn btn-warning shadow-sm font-weight-bold">
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td style="text-align: start;"><?php echo $data['nama_pelanggan']; ?></td>
                <td style="text-align: start;"><?php echo $data['alamat']; ?></td>
                <td><?php echo $data['no_telepon']; ?></td>
                <td>
                  <div class="action-buttons">
                    <a class="btn btn-success btn-sm" href="pelanggan-ubah.php?id_pelanggan=<?php echo $data['id_pelanggan']; ?>" role="button">Ubah</a>
                    <a class="btn btn-danger btn-sm" href="pelanggan-hapus.php?id_pelanggan=<?php echo $data['id_pelanggan']; ?>" onclick="return confirm('yakin hapus?')">Hapus</a>
                  </div>
                </td>
              </tr>
            <?php } ?>
