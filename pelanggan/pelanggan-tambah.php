...
if (isset($_POST['proses'])){
    ...
    mysqli_query($conn, "INSERT INTO pelanggan VALUES('$id_pelanggan','$nama_pelanggan','$alamat','$no_telepon')");
      ...
      <div class="form-container">
        <form action="" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" name="id_pelanggan" id="id_pelanggan" class="form-control" placeholder="Masukkan ID Pelanggan" required>
          </div>

          <div class="form-group">
            <label for="nama_pelanggan" class="form-label">Nama Pelanggan</label>
            <input type="text" name="nama_pelanggan" id="nama_pelanggan" class="form-control" placeholder="Masukkan Nama Lengkap" required>
          </div>
