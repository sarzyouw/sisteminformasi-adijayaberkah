...
if (isset($_POST['proses'])) {
    ...
    mysqli_query($conn, "UPDATE pelanggan SET nama_pelanggan='$nama_pelanggan',alamat='$alamat', no_telepon='$no_telepon' WHERE id_pelanggan='$id_pelanggan'");
  ...
  <div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar">
      <div class="p-4 pt-5 text-center">
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li class="active"><a href="#pelanggan" data-toggle="collapse" aria-expanded="false"><i class="fas fa-users"></i> Pelanggan</a></li>
    ...
    <div id="content" class="main-content">
      <div class="page-header">
        <h1 class="page-title">Ubah Data Pelanggan</h1>
        <a href="pelanggan-lihat.php" class="btn btn-warning shadow-sm font-weight-bold">
      ...
      <div class="form-container">
        <form action="" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" name="id_pelanggan" id="id_pelanggan" class="form-control" value="<?= $data['id_pelanggan'] ?>" readonly>
          </div>

          <div class="form-group">
            <label for="nama_pelanggan" class="form-label">Nama Pelanggan</label>
            <input type="text" name="nama_pelanggan" id="nama_pelanggan" class="form-control" value="<?= $data['nama_pelanggan'] ?>" required>
          </div>
          ...
          <div class="action-buttons">
            <a href="pelanggan-lihat.php" class="btn btn-danger">
