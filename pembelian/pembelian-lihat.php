  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="main-content">
      <div class="page-header">
        ...
        <a href="pembelian-tambah.php" class="btn btn-warning shadow-sm font-weight-bold">
        ...
        <table id="example" class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            while ($data = mysqli_fetch_array($query)) {
              ...
              $jumlah_rp = $data['jumlah_rp'] ? 'Rp ' . number_format($data['jumlah_rp'], 0, ',', '.') : 'Belum dihitung';
            ?>
              <tr>
                <td><?php echo $data['id_pembelian']; ?></td>
                <td style="text-align: start;"><?php echo $data['nama_supplier']; ?></td>
                ...
                <td>
                  <div class="action-buttons">
                    <a class="btn btn-success btn-sm" href="pembelian-ubah.php?id_pembelian=<?php echo $data['id_pembelian']; ?>">Ubah</a>
                    <a class="btn btn-danger btn-sm" href="pembelian-hapus.php?id_pembelian=<?php echo $data['id_pembelian']; ?>" onclick="return confirm('yakin hapus?')">Hapus</a>
                  </div>
                </td>
                <td>
                  <div class="action-buttons">
                    <a class="btn btn-info btn-sm" href="pembeliandetail-lihat.php?id_pembelian=<?php echo $data['id_pembelian']; ?>">Detail</a>
                    <a class="btn btn-primary btn-sm" href="pembeliancetak.php?id_pembelian=<?php echo $data['id_pembelian']; ?>">Cetak</a>
                  </div>
                </td>
              </tr>
            <?php } ?>
