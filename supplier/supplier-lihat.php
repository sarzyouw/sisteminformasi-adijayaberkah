  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="main-content">
      <div class="page-header">
        ...
        <a href="supplier-tambah.php" class="btn btn-warning shadow-sm font-weight-bold">
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><?php echo $data['no_pic']; ?></td>
                <td>
                  <div class="action-buttons">
                    <a class="btn btn-success btn-sm" href="supplier-ubah.php?id_supplier=<?php echo $data['id_supplier']; ?>" role="button">Ubah</a>
                    <a class="btn btn-danger btn-sm" href="supplier-hapus.php?id_supplier=<?php echo $data['id_supplier']; ?>" onclick="return confirm('yakin hapus?')">Hapus</a>
                  </div>
                </td>
              </tr>
            <?php } ?>
