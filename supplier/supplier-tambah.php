...
if (isset($_POST['proses'])){
    ...
    mysqli_query($conn, "INSERT INTO supplier VALUES('$id_supplier','$nama_supplier','$alamat','$no_telepon','$nama_pic','$no_pic')");
      ...
      <div class="form-container">
        <form action="" method="post">
          <div class="form-group">
            ...
            <input type="text" name="id_supplier" id="id_supplier" class="form-control" placeholder="Masukkan ID Supplier" required>
          </div>

            <div class="form-group">
                <label for="nama_supplier" class="form-label">Nama Supplier</label>
                <input type="text" name="nama_supplier" id="nama_supplier" class="form-control" placeholder="Masukkan Nama Lengkap" required>
            </div>
             ...
             <div class="form-group">
                ...
                <input type="text" name="no_pic" id="no_pic" class="form-control" placeholder="Masukkan Nomor PIC" required>
            </div>
