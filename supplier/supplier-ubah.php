<?php
include '../koneksi.php';
$query = mysqli_query($conn, "SELECT * FROM supplier WHERE id_supplier = '$_GET[id_supplier]'");
...
if (isset($_POST['proses'])) {
  ...
  mysqli_query($conn, "UPDATE supplier SET nama_supplier='$nama_supplier',alamat='$alamat',no_telepon='$no_telepon',nama_pic='$nama_pic',no_pic='$no_pic' WHERE id_supplier='$id_supplier'");
    ...
    <nav id="sidebar">
      <div class="p-4 pt-5 text-center">
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li class="active"><a href="#supplier" data-toggle="collapse" aria-expanded="false"><i class="fas fa-truck"></i> Supplier</a></li>
      ...
      <div class="page-header">
        ...
        <a href="supplier-lihat.php" class="btn btn-warning shadow-sm font-weight-bold">
      ...
      <div class="form-container">
        <form action="" method="post">
          <div class="form-group">
            ...
            <input type="text" name="id_supplier" id="id_supplier" class="form-control" value="<?= $data['id_supplier'] ?>" readonly>
          </div>

            <div class="form-group">
                <label for="nama_supplier" class="form-label">Nama Supplier</label>
                <input type="text" name="nama_supplier" id="nama_supplier" class="form-control" value="<?= $data['nama_supplier'] ?>" required>
            </div>
             ...
             <div class="form-group">
                <label for="nomor telepon" class="form-label">Nomor Telepon Supplier</label>
                <input type="text" name="no_telepon" id="no_telepon" class="form-control" value="<?= $data['no_telepon'] ?>" required>
            </div>

             <div class="form-group">
                <label for="nama_pic" class="form-label">Nama PIC</label>
                <input type="text" name="nama_pic" id="nama_pic" class="form-control" value="<?= $data['nama_pic'] ?>" required>
            </div>
            
             <div class="form-group">
                <label for="no_pic" class="form-label">Nomor Telepon PIC</label>
                <input type="text" name="no_pic" id="no_pic" class="form-control" value="<?= $data['no_pic'] ?>" required>
            </div>

           <div class="action-buttons">
            <a href="supplier-lihat.php" class="btn btn-danger">
